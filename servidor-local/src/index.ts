...
app.use(cors({
    origin: ["http://localhost:3000", "https://servidor-local-center-backend2.onrender.com", "https://stiven-gulugulu.vercel.app/","https://servidor-local-front-me74.vercel.app/login" ,"https://servidor-local-front-ts.vercel.app", "https://servidor-local-center-three.vercel.app"],
    credentials: true,
