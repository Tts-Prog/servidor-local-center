...
| :---------- | :--------------------------------------- | :------------------- | :--------------------- |
| `/login`    | **Dados Corretos** (Credenciais válidas) | 200 OK               | [Preencher. Ex: 11.29ms] |
| `/login`    | **Dados Errados** (Password incorreta)   | 400 ou 401           | [Preencher. Ex: 251ms] |
| `/registro` | **Dados Corretos** (Novo utilizador)     | 201 Created          | [Preencher. Ex: 1.95s] |
| `/registro` | **Dados Errados** (Email já existente)   | 400 ou 409           | [Preencher. Ex: 1.67s] |
