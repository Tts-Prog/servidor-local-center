...
export async function createUser(id, nome, numero_identidade, data_nascimento, email, password, telefone, pais, localidade, enebled, created_at, update_at) {
    try {
        const [rows] = await db.execute(`INSERT INTO tbl_utilizadores
