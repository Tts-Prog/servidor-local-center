...
export const PrestadorController = {
    ...
    get: async (req, res) => {
        const prestador = await PrestadorModel.get(req.params.id);
        if (!prestador)
    ...
    update: async (req, res) => {
        const prestador = await PrestadorModel.update(req.params.id, req.body);
        if (!prestador)
    ...
    delete: async (req, res) => {
        const prestador = await PrestadorModel.delete(req.params.id);
        if (!prestador)
